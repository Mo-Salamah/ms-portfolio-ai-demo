...
الهدف: تمكين فريق عمل لجنة الفعاليات من الإشراف على هيئات التطوير في إطار تطوير تقاويم المدن، من خلال جمع وتحليل بيانات الفعاليات وضمان جاهزية المعلومات للجان الإشرافية.

النطاق:
- التنسيق مع هيئات التطوير لجمع بيانات الفعاليات
- تحليل البيانات وتحديد الفجوات
- إعداد التقارير الدورية للجنة الإشرافية
- متابعة استكمال المعلومات الناقصة

الجهات المعنية:
- ثلاث هيئات تطوير رئيسية
- اللجنة الإشرافية العليا
- فريق التنسيق والمتابعة

الموعد النهائي: اجتماع اللجنة - ١ سبتمبر ٢٠٢٧""",
    "memory": [
        {"date": "١٧ يناير ٢٠٢٧", "entry": "تم استلام ملف الفعاليات المحدث من هيئة التطوير (أ)"},
        {"date": "١٥ يناير ٢٠٢٧", "entry": "هيئة التطوير (ب) طلبت تمديد موعد تسليم البيانات"},
        {"date": "١٠ يناير ٢٠٢٧", "entry": "اجتماع تنسيقي مع فريق المتابعة — تم الاتفاق على قالب موحد"},
        {"date": "٥ يناير ٢٠٢٧", "entry": "إرسال طلب البيانات الأولي لجميع الهيئات"},
    ],
    "system_knowledge": "مدرّب على بيانات تقاويم الفعاليات المستلمة من هيئات التطوير",
    "available_files": [],
    "capabilities": [
